  ...
  group('PrecisionExt', () {
    ...
    group('isBeforeWithPrecision', () {
      test('compares at precision level', () {
        ...
        expect(h1.isBeforeWithPrecision(h2, precision: TimePrecision.day), isTrue);
        expect(h2.isBeforeWithPrecision(h1, precision: TimePrecision.day), isFalse);
      });
    });

    group('truncateTo', () {
      final h = Hora.of(year: 2024, month: 3, day: 15, hour: 14, minute: 30, second: 45);
