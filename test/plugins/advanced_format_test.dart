  ...
  group('AdvancedFormatExt', () {
    group('advancedFormat', () {
      test('formats ordinal day (Do)', () {
        ...
        expect(Hora.of(year: 2024, month: 3, day: 2).advancedFormat('Do'), '2nd');
        expect(Hora.of(year: 2024, month: 3, day: 3).advancedFormat('Do'), '3rd');
        expect(Hora.of(year: 2024, month: 3, day: 4).advancedFormat('Do'), '4th');
        expect(Hora.of(year: 2024, month: 3, day: 11).advancedFormat('Do'), '11th');
        expect(Hora.of(year: 2024, month: 3, day: 21).advancedFormat('Do'), '21st');
      });
    ...
    group('dayOfYear getter', () {
      test('returns correct day of year', () {
        ...
        expect(Hora.of(year: 2024, month: 12, day: 31).dayOfYear, 366); // leap year
        expect(Hora.of(year: 2023, month: 12, day: 31).dayOfYear, 365); // non-leap
      });
    });
  });
}
